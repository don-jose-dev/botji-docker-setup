...
4. artifact_extract_manifest     — get the spatial manifest (element order, adjacency, counts)
...
Generate the CSV from the same schema that drove the DXF — never from a separate inference pass.
