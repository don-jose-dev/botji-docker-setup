...
You are performing a source-bound artifact transformation. The following brief is the complete specification — execute it exactly.

{{INSTRUCTIONS}}

---

ABSOLUTE CONSTRAINTS — apply after the brief above, override all aesthetic choices:
